...
export class Viewer {
  ...
  public async loadVrm(
    ...
    // Karakteri biraz aşağı kaydır
    this.model.vrm.scene.position.y = -2.0;
  ...
  public resetCamera() {
    ...
    if (headNode) {
      ...
      // Karakteri ekranda aşağı göstermek için kamerayı yukarı kaydır
      const offsetY = 0.15;
      ...
      this.cameraControls?.target.set(headPos.x, headPos.y + offsetY, headPos.z);
