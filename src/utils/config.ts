...
export const defaults = {
  ...
  bg_url: process.env.NEXT_PUBLIC_BG_URL ?? '/newBG.png',
  vrm_url: process.env.NEXT_PUBLIC_VRM_HASH ?? '/vrm/MikaFox.vrm',
  vrm_hash: '',
  vrm_save_type: 'web',
  youtube_videoid: '',
  animation_url: process.env.NEXT_PUBLIC_ANIMATION_URL ?? '/animations/mikaAnimation.vrma',
...
// ...existing code...
  ...
  vision_backend: process.env.NEXT_PUBLIC_VISION_BACKEND ?? 'vision_ollama',
