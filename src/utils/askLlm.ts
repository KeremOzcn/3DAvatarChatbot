...
import { getGeminiChatResponseStream } from "@/features/chat/geminiChat"; // eklendi
...
export async function askLLM(
  ...
  const getChatResponseStream = async (messages: Message[]) => {
    ...
    switch (chatbotBackend) {
      case "openai":   // eklendi: defaults 'openai' olduğunda OpenAI'ye yönlendir
      case "chatgpt":
